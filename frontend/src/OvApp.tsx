...
function OVApp() {
  ...
  const intro =
    "Deze website is geoptimaliseerd voor blinde mensen.   Je kan het volgende element selecteren met de tab-toets en teruggaan met shift-tab.   Met enter selecteer je een element. En met f7 hoor je deze instructies opnieuw.";
  ...
  return (
    <div className="box-1">
      ...
      <h1
        tabIndex={1}
        aria-label='"Deze website is geoptimaliseerd voor blinde mensen. Je kan het volgende element selecteren met de tab-toets en teruggaan met shift-tab.  Met enter selecteer je een element";'
      >
        OV Stations Selector
      </h1>
      <p
        tabIndex={1}
        aria-label="Waneer je het station aan het invoeren bent zal er een uitklap menu komen waar je met de pijltoesten door heen kan en met enter kan selecteren"
      ></p>
      ...
      <DateAndTime
        ...
        availableDates={[
          { id: 1, dateTime: "2025-03-10T14:00:00", isAvailable: true },
          { id: 2, dateTime: "2025-03-11T11:00:00", isAvailable: true },
          { id: 3, dateTime: "2025-03-12T11:00:00", isAvailable: true },
        ]}
      />
